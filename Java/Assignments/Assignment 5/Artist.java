...
class ArtistTest{
    public static void main(String[] args) {
        Painter painter = new Painter("ABC", 40, "Modern Art", "Brush and Board",100);
        painter.detail();

        Musician musician = new Musician("Ajay-Atul", 36, "Band", "classic", 101);
        musician.detail();

        Actor actor = new Actor("Pravin tarde", 40, "Marathi Film Industry", 26);
        actor.detail();
    }
}
