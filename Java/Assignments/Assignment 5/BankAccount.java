...
class BankTest{
    public static void main(String[] args) {
        SavingAccount saving = new SavingAccount(12345,"Harshal Bade", 100000,1234567890,1000,50000);
        saving.withdrawal(4000);

        CurrentAccount current = new CurrentAccount(11112,"Harry Bade", 200000, 1234512345, 500000, 300000);
        current.withdrawal(12000);
    }
}