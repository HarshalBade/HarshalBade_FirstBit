...
class TestLogin{
    public static void main(String[] args) {
        PasswordLogin pass = new PasswordLogin(101,"Harshal","harshal123","harshal@1c3");
        pass.authenticate();

        BiometricLogin bio = new BiometricLogin(102,"Harry","Harry123","xyz","pqr");
        bio.authenticate();

        OTPLogin otp = new OTPLogin(103,"Harshal","harshal@123",1234567890);
        otp.authenticate();
    }
}