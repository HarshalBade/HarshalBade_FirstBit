...
class VehicleTest{
    public static void main(String[] args) {
        Vehicle vehicle = new Bike(1234, "NS160", "Pulsur", 2, 150000, 1, 1, "Petrol");
        vehicle.display();

        vehicle = new Car(1111, "X7", "BMW", 4, 2500000, true, "Automatic", "ObjectDetection");
        vehicle.display();

        vehicle = new Bus(2222, "Traveller", "Borce", 6, 2000000, 22, 10);
        vehicle.display();
    }
}
