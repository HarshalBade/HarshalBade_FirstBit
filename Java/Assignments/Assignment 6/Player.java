...
class PlayerDetail{
    public static void main(String[] args) {
        Player player = new CricketPlayer("Virat Kohli",37,"India",600,18, 28800,9,"Percision","Medium Pacer");
        player.display();

        player = new FootballPlayer("Sunil Chhetri", 40, "India", 150, 11, 100,"Attacker");
        player.display();
    }
}
